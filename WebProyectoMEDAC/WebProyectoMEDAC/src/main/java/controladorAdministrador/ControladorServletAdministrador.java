...
import boAdministrador.BoAdministrador;
...
public class ControladorServletAdministrador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(action.equals("insertar")) {
            BoAdministrador.procesarPeticionInstertarAdministrador(request, response);
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ControladorServletAdministrador2</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ControladorServletAdministrador2 at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
